...
SHOW_ITEM_GROUP(CMD_Group,Normal85,280,110,307,137)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_StaticIcon_PIMC,0,280,110,307,137)
...
SHOW_ITEM_GROUP(CMD_Group,Normal103,112,5,139,32)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_GSENSOR,0,112,5,139,32)
