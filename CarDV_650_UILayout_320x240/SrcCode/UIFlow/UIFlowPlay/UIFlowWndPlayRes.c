...
SHOW_ITEM_RECT(CMD_Rectangle,Skin104Rect,0,0,101,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin104)
SHOW_MAP_BODY(Skin104Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin104,0,0,101,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text106,0,0,101,27,STRID_NULL,0,1280,0,0,3,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal103)
SHOW_MAP_BODY(Skin104)
SHOW_MAP_BODY(Text106)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal103,207,32,308,59)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_MovPlayTime,0,207,32,308,59)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin134Rect,0,0,101,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin134)
SHOW_MAP_BODY(Skin134Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin134,0,0,101,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text136,0,0,101,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal133)
SHOW_MAP_BODY(Skin134)
SHOW_MAP_BODY(Text136)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal133,207,32,308,59)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_MovTotalTime,0,207,32,308,59)
